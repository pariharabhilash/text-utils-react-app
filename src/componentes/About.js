        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              ...
              character count & word count statics for a given text. Utils
              reports the number of words and characters. thus it is suitable
              for writing next word/character limit.
            </div>
          </div>
        </div>
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={myStyle}>
              This word counter software works in any web browser such as a
              chrome, firefox.internet explore,safari,opera. It suits a count
